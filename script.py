...
script = {
    ...
    "main_flow": {
        ...
        "help_node": {RESPONSE: "/start or /is_positive"},
        "fallback_node": {RESPONSE: "Ooops"},
    },
...
actor = Actor(script, start_label=("main_flow", "start_node"), fallback_node=("main_flow", "fallback_node"))
